...
@DETECTORS.register_module()
class TransFusionDetectorFiltered(MVXTwoStageDetector):
    """Base class of Multi-modality VoxelNet."""

    def __init__(self, **kwargs):
        super(TransFusionDetectorFiltered, self).__init__(**kwargs)
    ...
    def init_weights(self, pretrained=None):
        """Initialize model weights."""
        super(TransFusionDetectorFiltered, self).init_weights(pretrained)
